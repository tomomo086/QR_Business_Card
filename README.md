...
## 📱 プロジェクト概要
**技術力と創造性を実物で体感できるポートフォリオ作品**として、3Dプリンター(Neptune 4 Pro)を活用した革新的なQRコード名刺を開発。従来の名刺の概念を覆すモジュラー設計とマルチマテリアル印刷技術により、デジタル統合とユーザビリティを両立した実用的なソリューションを実現。面談での技術的アピールと実用性を兼ね備えた差別化ツールとして完成。
...
### 📸 **ユーザビリティ設計**
- **ライフサイクル設計**: 名刺としての使用後も写真立てとして継続的な価値を提供
